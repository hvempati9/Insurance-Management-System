...
public class VerifyUser extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email) {
        ...
        dtm.setRowCount(0);
        ArrayList<User> list = Insurance_AppUser_dao.getAllRecords(email);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(445, 25, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setText("Search");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(393, 104, -1, -1));
        ...
        getContentPane().add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(1215, 25, -1, -1));
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(485, 101, 300, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 147, 1219, 440));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (a==0) {
            Insurance_AppUser_dao.changeStatus(email,status);
            setVisible(false);
